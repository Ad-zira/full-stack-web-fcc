<script lang="ts">
  ...
  /* const done = todo.done; */ // can also do this
</script>
...
<style>
  ...
  .todo button {
    ...
    background-position: 50% 50%; /* a circle */
  ...
  /* TODO: Uncomment whenn the API endpoints are available */
  .done {
    transform: none;
    opacity: .5;
...
<!-- dynamic class attribute called done, to add conditionally -->
