<script context="module" lang="ts">
  ...
  // importing the enhance function for the form
  ...
  {#each todos as todo}
    <TodoItem 
      ...
      processDeletedTodoResult={() => {
        todos = todos.filter(t => t.uid !== todo.uid) // an individual todo if the uid is not equal to the todo uid, then keep it. Otherwise drop it.
      }}
